...
const projects: Project[] = [
  ...
  },
  {
    ...
    title: "JHAKKAS",
    year: "2026",
    description: "Jhakkas — A modern streetwear e-commerce website focused on bold fashion, smooth shopping experience, and premium UI/UX.",
  ...
  },
  {
    ...
    title: "BOOKMART",
    year: "2026",
    description: "BooksMart — A modern online bookstore designed for seamless book discovery, browsing, and shopping with a clean and user-friendly interface.",
...
"#"
  return (
    <section className="py-20 md:py-36 bg-[#050505] relative z-10" id="work">
        ...
        <div className="flex flex-col gap-16 md:gap-28">
          {projects.map((project) => (
            ...
            >
              ...
              <div 
                className="lg:col-span-6 xl:col-span-6 w-full aspect-[16/10] bg-[#0c0c0c] border border-white/[0.04] relative overflow-hidden rounded-sm group cursor-pointer shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
              ...
              <div className="lg:col-span-6 xl:col-span-6 flex flex-col justify-center lg:pl-2">
                ...
                <div className="flex items-center gap-3 mb-2.5 sm:mb-3.5">
                  ...
                  <span className="text-[#666666] font-mono text-[10px] sm:text-[11px] md:text-xs">{project.year}</span>
                </div>
